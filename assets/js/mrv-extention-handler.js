jQuery("document").ready(function ($) {
  ...
  function handleClickEvent(e) {
    ...
    $(".mrv-vote-btn").on("click", function (e) {
      ...
      let MetaMaskEnable =
        wallets_data.wallets_enable.metamask_wallet != undefined &&
        wallets_data.wallets_enable.metamask_wallet != ""
          ? wallets_data.wallets_enable.metamask_wallet
          : "1";
      let BinanceEnable =
        wallets_data.wallets_enable.binance_wallet != undefined &&
        wallets_data.wallets_enable.binance_wallet != ""
          ? wallets_data.wallets_enable.binance_wallet
          : "1";
      let WalletCEnable =
        wallets_data.wallets_enable.wallet_connect != undefined &&
        wallets_data.wallets_enable.wallet_connect != ""
          ? wallets_data.wallets_enable.wallet_connect
          : "1";
      ...
      if (MetaMaskEnable == "1") {
        pophtml +=
          ...
          '<div class="mrv-wallet-icon" ><img src="' +
          wallets_data.url +
          'assets/images/images/metamask.png" alt="metamask" ></div>' +
          '<div class="mrv-wallet-title" >' +
          wallets_data.const_msg.metamask_wallet +
          "</div>" +
      ...
      if (BinanceEnable == "1") {
        pophtml +=
          ...
          '<div class="mrv-wallet-icon" ><img src="' +
          wallets_data.url +
          'assets/images/images/binance.jpg" alt="metamask" ></div>' +
          '<div class="mrv-wallet-title" >' +
          wallets_data.const_msg.binance_wallet +
          "</div>" +
          '<svg height="32" width="32" fill="#545454" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M96,212a4,4,0,0,1-2.82861-6.82837L170.34326,128,93.17139,50.82837a4.00009,4.00009,0,0,1,5.65722-5.65674l80,80a4,4,0,0,1,0,5.65674l-80,80A3.98805,3.98805,0,0,1,96,212Z"></path> </g></svg>' +
          "</li >";
      }
      if (WalletCEnable == "1") {
        pophtml +=
          ...
          '<div class="mrv-wallet-icon" ><img src="' +
          wallets_data.url +
          'assets/images/images/walletconnect.png" alt="metamask" ></div>' +
          '<div class="mrv-wallet-title" >' +
          wallets_data.const_msg.wallet_connect +
          "</div>" +
          '<svg height="32" width="32" fill="#545454" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M96,212a4,4,0,0,1-2.82861-6.82837L170.34326,128,93.17139,50.82837a4.00009,4.00009,0,0,1,5.65722-5.65674l80,80a4,4,0,0,1,0,5.65674l-80,80A3.98805,3.98805,0,0,1,96,212Z"></path> </g></svg>' +
          "</li >";
      }
  ...
  $(".mrv-vote-btn").on("click", debounce(handleClickEvent, 250)); // 250ms debounce time
});
...
function MrvExtentionCall(
  ...
  try {
    ...
    let vote_msg =
      wallet_id == "wallet_connect" ||
      EnableWconnect == true ||
      wallet_id == "Binance_wallet"
        ? messageHashBytes
        : msg;
    const trans = signer
      .signMessage(vote_msg)
